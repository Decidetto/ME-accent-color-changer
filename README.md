# Marinara Engine Accent Colour Changer
...
- Per-theme defaults computed dynamically from the active theme's base colours via `getComputedStyle`, with live re-anchoring on theme switches.
